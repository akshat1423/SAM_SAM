  ...
  return (
    <div className='a'>
      <div className="footer">
        <div className="footer-section">
          <div className="footer-logo">
            <img src='data:image/png;base64,'
              alt='sarclogo'></img>
          </div>
          <div className="footer-query">
            <h4>Send your query</h4>
            <div className="query-form">
              <input type='query' placeholder="Enter your query" />
        ...
        <div className="footer-section">
          ...
          <div className="footer-map-icon">
            <a href="https://maps.app.goo.gl/EcbsqPgWn29jmGtr5" target="_blank" rel="noopener noreferrer">
              <FaMapMarkerAlt size={32} color="#0d6dcf" />
              <span className="map-text">SARC Room,IITB</span>
            </a>
          </div>
          <br />
          <IoMdMail size={32} color="#0d6dcf" />
          <span className='mail-text'><a href="mailto:web@sarc-iitb.org">web@sarc-iitb.org</a></span>
        </div>
      </div>
      <div className="footer-social">
        <h2 id='b'>Get connected with us on social networks:</h2>
        <div className="social-icons">
          <a href="https://in.linkedin.com/in/sarciitb" target="_blank" rel="noopener noreferrer" className="linkedin">
            <li><FontAwesomeIcon icon={faLinkedin} size='2x' /></li>
          </a>
          <a href="https://www.instagram.com/sarc_iitb?igsh=MWlvc2R3djN3a2t0ZQ==" target="_blank" rel="noopener noreferrer" className="instagram"><li><FontAwesomeIcon icon={faInstagram} size='2x' /></li></a>
          <a href="https://www.youtube.com/c/SARCIITBombay" target="_blank" rel="noopener noreferrer" className="youtube"> <li><FontAwesomeIcon icon={faYoutube} size='2x' /></li></a>
          <a href="https://www.facebook.com/SARC.IITB" target="_blank" rel="noopener noreferrer" className="facebook"><li><FontAwesomeIcon icon={faFacebook} size='2x' /></li></a>
        </div>
      </div>
    </div>
  );
